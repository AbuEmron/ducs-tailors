...
/**
 * The form itself, split out so that it is only ever composed with a profile in hand.
 *
 * Keeping the remembered drafts inside a composable that cannot be entered without a
 * profile means they are created once, keyed to that profile, rather than sitting behind a
...
private fun EditProfileForm(
    ...
    var areaLabel by remember(profile.id) {
    ...
    ScreenColumn(contentPadding = contentPadding) {
        ...
        LabelledField(
            ...
            helper = "This is what other members see. It does not have to be your legal " +
                "name.",
            ...
            ChoiceRow(
                ...
                description = when (style) {
                    ...
                    ProfileImageStyle.PHOTOGRAPH ->
                        "A photograph, shown only to the audience you choose under privacy " +
                            "controls."
                },
        ...
        ContentCard {
            ...
            Text(
                text = "Your verification level, your roles and anything a reviewer " +
                    "confirmed are set by the platform, not by you. That is what makes them " +
                    "worth anything to the person reading your profile.",
        ...
        PrivacyNote(
            text = "Who can see your real name, your area and your image is decided under " +
                "privacy controls, not here. Changing this page does not change who it is " +
                "shown to.",
            modifier = Modifier.padding(horizontal = spacing.screenHorizontal),
        )
